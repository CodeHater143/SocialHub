...
app.get('/',function(req,res){
   ...
   //how to fetch data from db and show it to users
   //{} is a object in which search query is written
   Contact.find({},function(err,contacts){   // modifiy {} -->{name:'ankur prasad'}
       if(err)
       {
           console.log('error in fetching contacts from db',err);
           return ;
       }
       //sending a response to browser(home.ejs which is present in views directory ) from database
...
app.get('/practice',function(req,res){
 ...
 app.get('/delete-contact/',function(req,res){
    ...
    //how to find data looking into database by id and delete it
