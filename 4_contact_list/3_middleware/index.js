...
//how to write own middleware
app.use(function(req,res,next){
    //console.log('middleware first is called');

    // req is an object
    req.fname='mahesh babu';  //{fname:'mahesh babu'} is added (key-value pair)

    next(); // call next middleware if present otherwise call required url
});

app.use(function(req,res,next){
    //console.log('middleware second is called');
    console.log('fname from mw2 is:',req.fname);
    next();
});
